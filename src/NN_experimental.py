...
def get_model(time_samples_num,channels_num,dropouts,fiter_params):
    # rn_init = RandomNormal(stddev=0.001,seed=1)
    #First
    num_of_filt = fiter_params[0]
    ...
    fc2 = Dense(2,activation=None)(flatten)
    out = Activation(activation='softmax')(fc2)
